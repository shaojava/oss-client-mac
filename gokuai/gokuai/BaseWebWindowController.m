...
-(void) awakeFromNib
{
    ...
    [baseWebview setCustomUserAgent:
     [NSString stringWithFormat:@"GK_SYNC;%@;Mac;GK_YUNKU;Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.1916.114 Safari/537.36",[[Util getAppDelegate]appversion]]
     ];
